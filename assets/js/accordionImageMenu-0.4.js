...
(function( $ ){
	...
	function accordionMenuSetting(obj,settings) {		
			...
			$.each($this, function(i) {	
				...
				$('img',this).hide();
				width_caption = (_this.menuSettings.position == 'horizontal') ? _this.menuSettings.openDim : _this.menuSettings.width;
				$('.caption',this).css({'width':width_caption});
				
				if (_this.menuSettings.shadow && i < $this.length - 1 && _this.menuSettings.position == 'horizontal') {
