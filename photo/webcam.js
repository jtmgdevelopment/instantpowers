...
window.webcam = {
	...
	swf_url: '/photo/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '/photo/shutter.mp3', // URI to shutter.mp3 sound
		...
		switch (type) {
			...
			case 'error':
				...
				if (!this.fire_hook('onError', msg)) {
					alert("JPEGCam Flash Error: " + msg+ ' Web Camera is needed to upload powers.');
				}
				break;
			...
			default:
				...
				alert("jpegcam flash_notify: " + type + ": " + msg + ' Web Camera is needed to upload powers.' );
				break;
		}
	}
};
