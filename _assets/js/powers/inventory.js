...
(function( $, app, helper ){
	...
	$( 'form#recoup_powers' ).submit(function(){
		...
		if( valueArray.length == 0 ) 
		{
			...
			location.href = '/agent/power_inventory/recoup_powers';
			return false;	
		...
		var options = {
				type 	: 'POST',
				url		: '/agent/power_inventory/process_recoup_powers',
				data	: { 'recoup' : valueArray.join() },
				success : function( data )
				{
					
					
					location.href = '/agent/power_inventory/index/message';
				},
				error : function( data )
				{
	...
	$( 'form#transfer_powers' ).submit(function(){
		...
		{
			alert( 'Please add at least one power' );
			location.href = '/agent/power_inventory';
			return false;	
		...
		var options = {
				type 	: 'POST',
				url		: '/agent/power_inventory/process_transfer_powers',
				data	: { 'transfer' : valueArray.join() },
				success : function( data )
				{
					location.href = '/agent/power_inventory/choose_sub_agent';
				},
				error : function( data )
				{
