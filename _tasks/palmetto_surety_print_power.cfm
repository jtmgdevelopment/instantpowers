...
<cfoutput>
	<cfquery name="loc.power" datasource="#variables.dsn#">		
		SELECT DISTINCT
		psaj.mek as sub_mek, p.transferred_sub, p.power_id, p.pek, p.prefix_id, ps.status, ps.key, pd.execution_date,
		def.first_name, def.last_name, pp.prefix, pp.amount, pd.bond_amount, pd.county, p.exp_date, pd.city, pd.state,
		pd.court, pd.case_number, pd.charge, pd.executing_agent, DATE_FORMAT(pd.court_date, "%m/%d/%Y") as court_date, ba.mek
...
<cfquery name="agent" datasource="#variables.dsn#">
		SELECT m.full_name, bay.agency_name, m.address, m.phone, m.city, m.state, m.zip, ba.license_number, m.company as company
		from member as m
		INNER JOIN bail_agent AS ba 			
			ON	m.mek = ba.mek
		INNER JOIN bail_agency_agent_join AS baaj
		...
		<Cfif loc.power.transferred_sub eq 1>
			WHERE m.mek = <cfqueryparam value="#loc.power.sub_mek#" cfsqltype="cf_sql_varchar" />		
		<cfelse>
			WHERE m.mek = <cfqueryparam value="#loc.power.mek#" cfsqltype="cf_sql_varchar" />
...
<cfdocument format="pdf" orientation="portrait" filename="#loc.power_pdf#.pdf" overwrite="yes">
<style type="text/css">
...
<div style="margin:10px; width:800px;">
	<div class="power #loc.power.key#">
		<table width="100%">
			<tr>
				...
				<td id="insurance-company" align="center"><span id="mid" style="font-size:13px;">POWER OF ATTORNEY</span><br>
					...
					<span class="small" style=" padding:5px; font-size:11px;">109 River Landing Dr., Suite 200, Charleston, SC 29492-7595</span></td>
		...
		<div class="content">
			...
			<p>
				IN WITNESS WHEREOF, PALMETTO SURETY CORPORATION has caused these presents to be signed by it's duly authorized officer, proper for the purpose and its corporate seal to be hereunto affixed this #dateLetters(loc.power.execution_date)# day of #dateformat( loc.power.execution_date, 'mmmm')#.
			</p>
		</div>
	</div>
	...
	<div style="width:800px;">
		<div style="width:500px; float:left">
			<p style="font-size:12px;">Palmetto Surety Corporation<br />
				109 River Landing Dr., Suite 200<br />
				Charleston, SC 29492-7595</p>
			<p style="font-size:12px;"><strong>General Surety Appearance Bond</strong></p>
		...
		<div  style="width:250px; float:right">
			<p style="font-size:12px;">For Further Action On This Bond Notify:</p>
			<p style="font-size:12px;">
				<strong>#agent.company#</strong><br />
				<strong>#loc.power.executing_agent#</strong><br>
				#agent.address#<br>
	...
	<div class="inside-wrap">
		...
		<p style="font-size:12px;">
			Signed and sealed this <strong>#dateLetters(loc.power.execution_date)# day of #dateformat(loc.power.execution_date, 'mmmm')# AD... #dateformat( loc.power.execution_date, 'yyyy' )#</strong> <br />
	...
	<div style="width:400px; float:left">
		<p  style="font-size:12px;">Taken Before Me And Approved By Me:</p>
		<p  style="font-size:12px;">
	...
	<div class="inside-wrap-two" style="text-align:center;">
		<p style="font-size:12px;">STATEMENT: The Undersigned </p>
	</div>
	<div class="inside-wrap">
		<p style="font-size:12px;">
			I,
		...
		<p style="font-size:12px;">
			(Bondsman) #loc.power.executing_agent# <br />
...
<!---
	...
	<div id="fullwidth">
			...
			<table width="100%">
				<tr>
					<td align="center"><strong>#loc.power.bond_amount#</strong></td><td  align="center"><strong>BAIL BOND DEPARTMENT</strong></td><td align="center"><strong>#loc.power.prefix# #loc.power.pek#</strong></td>
				</tr>
				<tr>
			...
			<p>
				This is to certify that on or about the <strong>#dateLetters(now())# day of #dateformat( now(), 'mmmm')#</strong>, 
			...
			<p style="line-height:22px;">
					...
					Bond Executed this <strong>#dateLetters(now())# day of #dateformat( now(), 'mmmm')#</strong>			
			</p>				   	     								

			<table width="50%" cellpadding="5">
				<tr>
					<td><p><strong>Bond Amount</strong></p></td><td><p>#dollarformat(loc.power.bond_amount)#</p></td>
				</tr>
				<tr>
				...
				<tr>
					<td><p><strong>Defendant</strong></p></td><td><p>#loc.power.first_name# #loc.power.last_name#</p></td>
				</tr>		
				<tr>
					<td><p><strong>Court</strong></p></td><td><p>#loc.power.court#</p></td>
				</tr>		
				<tr>
					<td><p><strong>Case ##</strong></p></td><td><p>#loc.power.case_number#</p></td>
				</tr>		
				<tr>
					<td><p><strong>County/City,State</strong></p></td><td><p>#loc.power.county#, #loc.power.city# #loc.power.state#</p></td>
				</tr>		
				<tr>
					<td><p><strong>Offense</strong></p></td><td><p>#loc.power.charge#</p></td>
				</tr>		
				<tr>
					<td><p><strong>Executing Agent</strong></p></td><td><p>#loc.power.executing_agent#</p></td>
				</tr>		
			</table>		
	...
	--->	
		<Cfif variables.i neq loc.power.recordcount>
			<cfdocumentitem type="pagebreak" />
		</cfif>
...
<Cfset variables.i = incrementvalue( variables.i ) />
</Cfloop>
</cfdocument>
