...
<div style="margin:10px; width:800px;">
		...
		<table width="100%">
			<tr>
				...
				<td align="right" id="power-number">
					POWER ## #loc.power.prefix# #loc.power.pek#
					<br />
					POWER AMOUNT $ #loc.power.amount#					
				</td>
			</tr>
		</table>
		<div class="content">
			...
			<p style="background:##fff; padding:10px; border: 1px solid blue;">
				...
				<span class="blue large" style="display:block; text-align:center; font-size:13px; font-weight:bold">
					The obligation of the Company shall not exceed the sum of   #NumberAsString(rereplace( listfirst( loc.power.amount, '.' ), '[^0-9]', '', 'ALL' ))# (#dollarformat(rereplace( listfirst( loc.power.amount, '.' ), '[^0-9]', '', 'ALL' ))#) DOLLARS
				</span>
			</p>
			
			
			<p>
				IN WITNESS WHEREOF, NORTH RIVER INSURANCE COMPANY has caused these presents to be signed by it's duly authorized officer, proper for the purpose and its corporate seal to be hereunto affixed this #dateLetters(now())# day of #dateformat(now(), 'mmmm')#.
			</p>
		</div>
	</div>
	...
	<div style="width:800px; height:500px;">
		...
		<div style="width:350px; float:left; text-align:right;">
			...
			<div style="margin-top:20px;"> <img src="/_assets/power_assets/images/north-river-seal-signature.png" border="0"> </div>
		</div>
	</div>
	...
	<div style="width:800px;">
		...
		<div style="width:350px; float:left">
			<h3 style="font-size:13px;">
				POWER ##: <strong>#loc.power.prefix# #loc.power.pek#</strong>
				<br />
				AMOUNT: $ <strong>#loc.power.amount#</strong>

			</h3>
			<div style="width:140px; padding-top:83px; text-align:center;">
			<h4 style="font-size:14px;"><strong>STATE OF FLORIDA</strong></h4>
		...
		<div  style="width:350px; float:right">
			<h3 style="font-size:13px;">SEND ALL COURT NOTICES TO:</h3>
			...
			<h4 style="font-size:14px;"><strong>IN THE</strong><br />
			 <strong>#loc.power.court# Court</strong><br>
				<strong>#loc.power.county#</strong> County <br />STATE OF FLORIDA
	...
	<div style="width:330px; float:left">
		<h4  style="font-size:12px;">Taken Before Me And Approved By Me:</h4>
		<p  style="font-size:12px;">
	...
	<div style="width:250px; float:left; margin-left:50px;">
		...
		<p  style="font-size:12px;">
			...
			<br />
			<em>(Principal) NORTH RIVER INSURANCE COMPANY</em> <br />
	 ...
	 <cfdocumentitem type="pagebreak" />
      		 ...
      		 <div class="inside-wrap-three" style="border: 2px solid ##0073a0; padding:10px 5px 10px 5px; text-align:center; font-size:38px; font-weight:bold; color:##0073a0;">
           COURT COPY
            </div>
            ...
            <div class="one-half" style="text-align:right; font-size: 14px; line-height:15px;">
            	<small>
            	<strong>THE NORTH RIVER INSURANCE COMPANY</strong><br />
            	10350 Richmond Ave., Suite 300 &bull; Houston, TX 77042<br />P.O. Box 2807 &bull; Houston, Texas 77252-2807<br />
            	(713) 954-8100 &nbsp;&nbsp;&nbsp;&nbsp; (713) 954-8389 FAX
            	</small>
            </div>
            <br /><br />
		...
		<div class="" style="clear:both;">
             ...
             <div class="inside-wrap">
		<p  style="font-size:12px;">
            	<strong>Case Number:</strong> &nbsp; #loc.power.case_number# &nbsp;<br /><strong> Bond Amount:</strong> &nbsp; #dollarformat(loc.power.bond_amount)# &nbsp; <br /><strong>Power No.:</strong> &nbsp; #loc.power.prefix# #loc.power.pek#<br />
            	<strong>Defendant:</strong> &nbsp; #loc.power.first_name# #loc.power.last_name# &nbsp; <br /><strong>Court: #loc.power.court#</strong><br /><br />
            	This is to certify that on or about the day of ___________________________  I examined the records of Power No. #loc.power.prefix# #loc.power.pek# and found that the bond with corresponding power number has been discharged of record by reason of the following disposition &nbsp; ___________________________ &nbsp; Person rendering decision &nbsp; ___________________________ &nbsp; Date of Discharge &nbsp; ___________________________ , &nbsp; Witness my hand and official seal this day &nbsp; ___________________________  , &nbsp;  &nbsp; Title &nbsp; ___________________________
               </p>
            </div>
...
<cfif loc.power.recordcount gt 1 and loc.power.recordcount lt variables.counter>
	<cfdocumentitem type="pagebreak" />
</cfif>
