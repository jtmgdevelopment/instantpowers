<?= form_open('/annual_fee/process_fee_frm'); ?>

<section>
<h3 class="tit">The annual fee is: $<?= ANNUAL_FEE; ?></h3>
<p>This fee will be billed every 1 year from the initial fee payment date of: <strong><?= date('m/j/Y'); ?></strong></p>
<fieldset>
...
<div class="t-right">
	<p>
		...
		<button type="button" onClick="location.href = '/logout';"class="white">Logout</button>
	</p>
</div>
