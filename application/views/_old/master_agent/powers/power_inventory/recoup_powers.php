...
<? if( count( $transfers ) ): ?>
<?= form_open( '/master_agent/power_inventory/process_recoup_powers', array( 'id' => 'recoup_powers' ) ); ?>
<input type="hidden" name="recoup_powers" value="" />
<div class="t-right">
	<p class="box">
		<a href="/master_agent/power_inventory" class="btn-list"><span>Back To Inventory</span></a>
...
<table class="tablesorter">
	...
	<tbody>
		<? foreach( $transfers as $t ): ?>
			<tr>
				<td><input class="recoup" type="checkbox" name="recoup[]" value="<?= $t['prefix_id']; ?>-<?= $t['pek']; ?>-<?= $t['mek']; ?>" /></td>		
				<td><?= $t['full_name']; ?></td>		
				<td><?= $t['pek']; ?></td>		
				<td><?= $t['full_prefix']; ?></td>		
				<td><?= $t['exp_date']; ?></td>		
