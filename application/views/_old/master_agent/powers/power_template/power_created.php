...
<div id="page_wrap">
	...
	<div align="center">
		<button onClick="location.href = '/master_agent/powers/step_three/<?= $transmission->trans_id; ?>/<?= $powers->pek; ?>/<?= $powers->prefix_id; ?>';">Back To Transmission</button>&nbsp;&ndash;&nbsp;
		<button onClick="location.href = '/master_agent/powers/execute_power/<?= $transmission->trans_id; ?>/<?= $powers->pek; ?>';">Execute Power</button>&nbsp;&ndash;&nbsp;
		<button onClick="window.open( '/master_agent/powers/print_power/<?= $transmission->trans_id; ?>/<?= $is_batch; ?>/<?= $powers->prefix_id; ?>', '_blank' );">Print Power</button>
	</div>
