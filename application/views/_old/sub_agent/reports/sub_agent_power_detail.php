...
<p class="box">
	<? if( $status != 'inventory' ): ?>
		<a target="_blank" href="<?= safe_url( '/sub_agent/power_print', 'print_copy', array( $power[0][ 'pek' ], $power[0][ 'transmission_id' ], $power[0][ 'prefix_id' ], $power[0]['mek'] ) ); ?>" class="btn-list"><span>Print Copy Of Power</span></a>
	<? endif; ?>
</p>
