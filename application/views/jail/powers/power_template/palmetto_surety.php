...
<div id="page_wrap">
	...
	<div id="fullwidth">
		...
		<div id="power" class="<?= $power[ 'key' ]; ?>">
			...
			<div class="third">
				<span class="title">
					<?= power_get_prefix( $power[ 'prefix_id' ] ); ?>
				</span> 
				<span class="number">
					<?= $power[ 'pek' ]; ?>
				</span>
	...
	<div id="fullwidth">
		<div class="inside-wrap" align="center">
			<h2>IN THE <?= $power[ 'county' ]; ?> COURT OF THE JUDICIAL CIRCUIT IN AND FOR <?= $power[ 'county' ]; ?> COUNTY, FLORIDA</h2>	
		</div>
		<br clear="all">
		<div class="inside-wrap" align="center" style="width:250px; font-weight:bold;">	
		...
		<h3><strong>CLERK’S CERTIFICATE OF DISCHARGE OF BOND</strong></h3>
		</div>
		<div class="inside-wrap">
		
		<p>
		
		This is to certify that on the <?= date('jS'); ?> day of <?= date('F'); ?> I examined the records of <?= $power['defendant_first_name'] . ' ' . $power['defendant_last_name']; ?> and found that the bond with the corresponding power number(s) 
		below has been discharged by reason of the following disposition on <?= date('jS'); ?> day of <?= date('F'); ?>. 
		</p>
		</div>  
		<div class="inside-wrap" align="center">
			<table width="100%" align="center">
				<thead>
					<th align="center"><p><strong>CASE NUMBER</strong></p></th>
					<th align="center"><p><strong>POWER NO.</strong></p></th>
					<th align="center"><p><strong>CHARGE</strong></p></th>
					<th align="center"><p><strong>DISPOSITION</strong></p></th>
				</thead>
				<tbody>
					<tr>
						<td><p><?= $power[ 'case_number' ]; ?></p></td>
						<td><p><?= power_get_prefix( $power[ 'prefix_id' ] ); ?><?= $power[ 'pek' ]; ?></p></td>
						<td><p><?= $power[ 'charge' ]; ?></p></td>
						<td><p>___________________</p></td>
				</tbody>
			</table>		
		...
		SURETY:	<br />
				...
				<?= $agent['city']; ?> <?= $agent['state']; ?> <?= $agent['zip']; ?>
		<br /><br />
		Witness my hand and official seal this __________________________________. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		___________________________________________________________
		Deputy Clerk 
