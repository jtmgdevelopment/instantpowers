...
<div id="menu" class="box">
	...
	<ul class="box">
		...
		<li onmouseover="this.className = 'dropdown-on'" onmouseout="this.className = 'dropdown-off'">
			<div>
				<a href="/insurance/transmissions">
		...
		<li onmouseover="this.className = 'dropdown-on'" onmouseout="this.className = 'dropdown-off'">
			<div>
				<a href="/insurance/power_inventory">
		...
		<li onmouseover="this.className = 'dropdown-on'" onmouseout="this.className = 'dropdown-off'">
			<div>
				<a href="/insurance/power_prefix">
					<span>Manage Power Prefix</span>
				</a>
			</div>
		</li>
		<li onmouseover="this.className = 'dropdown-on'" onmouseout="this.className = 'dropdown-off'">
			<div>
				<a href="/insurance/reports">
					<span>Reports</span>
				</a>
			</div>
		</li>
