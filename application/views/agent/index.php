...
<div class="btn-box">
	...
	<div class="btn">
		<dl>	    
			<dt><a href="<?= safe_url('/agent/transmissions', 'index'); ?>">View Transmissions</a></dt>
...
<div class="btn-box">
	...
	<div class="btn">
		<dl>
			<dt><a href="<?= safe_url('/agent/power_inventory', 'index'); ?>">Powers Inventory</a></dt>
...
<div class="btn-box">
	...
	<div class="btn">
		<dl>
			<dt><a href="<?= safe_url('/agent/reports', 'index'); ?>">Reports</a></dt>
...
<div class="btn-box">
	...
	<div class="btn">
		<dl>
			<dt><a href="<?= safe_url('/agent/manage_credits', 'index'); ?>">Manage Credit Wallet</a></dt>
