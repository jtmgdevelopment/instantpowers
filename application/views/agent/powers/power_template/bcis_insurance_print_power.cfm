...
<div style="margin:10px; width:800px;">
	...
	<div style="width:800px;">
		...
		<div style="width:350px; float:left">
			<h3 style="font-size:13px;">Palmetto Surety Corporation<br />
				126 Seven Farms Drive, Suite 170<br />
				Charleston, SC 29492</h3>
			<h4 style="font-size:13px;"><strong>General Surety Appearance Bond</strong></h4>
		...
		<div  style="width:350px; float:right">
			<h3 style="font-size:13px;">For Further Action On This Bond Notify:</h3>
			<p style="font-size:13px;">
		...
		<div class="" style="clear:both;">
			<div style=" text-align:center;">
				...
				<div style="font-size:13px;" style="text-align:center">
				VS</div>
			<p style="font-size:13px;">
	...
	<div style="width:330px; float:left">
		<h4  style="font-size:13px;">Taken Before Me And Approved By Me:</h4>
		<p  style="font-size:13px;">
	...
	<div class="inside-wrap-two" style="text-align:center;">
		<h4 style="font-size:13px;">STATEMENT<br />
			The Undersigned </h4>
	</div>
	<div class="inside-wrap">
		<p style="font-size:13px;">
