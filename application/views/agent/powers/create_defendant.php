...
<?= form_open('/agent/create_powers/process_step_two'); ?>
...
<div class="t-right">
	<p>
		...
		<button type="button" class="white" onClick="location.href = '/agent/create_powers/cancel_power/<?= $trans_id; ?>/<?= $power_id ?>'">Cancel</button>
	</p>
</div>
