...
<? if( count( $power ) ): ?>
	<p class="box">
		<? if( $status != 'inventory' ): ?>
			<a class="btn-list" href="/agent/reports/view_power/<?= $power_details[ 'transmission_id' ] ?>/<?= $power_id; ?>"><span>View Power</span></a>

		<? endif; ?>
		<a class="btn-delete" href="/agent/create_powers/void/0/<?= $power_id; ?>/redirect"><span>Void Power</span></a>
		<? if( $status != 'inventory' ): ?>

			<a class="btn" href="/defendant/manage/view/<?= $power_id; ?>"><span>View Defendant</span></a>
		
			<a target="_blank" class="btn-list" href="/agent/create_powers/print_power_copy/<?= $power_id; ?>"><span>Print Power</span></a>
		<? endif; ?>
	</p>
