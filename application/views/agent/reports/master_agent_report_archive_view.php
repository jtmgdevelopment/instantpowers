<? if( count( $report ) ): ?>
<p class="box">
	<a target="_blank" href="/_tasks/print_master_report.cfm?var1=<?= $ins->mek; ?>&var2=<?= $this->session->userdata( 'mek' ); ?>&var3=<?= $report_id; ?>" class="btn-list"><span>Print Report <?= $report_num; ?></span></a>
</p>
