...
<div id="page_wrap">
	...
	<br>
	<div align="center">
		<button id="print" onClick="window.open( '/agent/create_powers/print_power_copy/<?= $power_id; ?>', '_blank' );">Print Power</button>
	</div>
	...
	<div id="fullwidth">
		...
		<div class="one-half-two first">
			<p>
				...
				&nbsp;&nbsp; <strong>
				<?= $p['defendant_first_name'] . ' ' . $p['defendant_last_name']; ?>
				</strong><br />
		...
		<div class="" style="clear:both;">
			<div style=" text-align:center;">
				...
				<h4 style="font-size:20px; margin-top:10px">
					<strong><?= $p['defendant_first_name'] . ' ' . $p['defendant_last_name']; ?></strong>
				</h4>
