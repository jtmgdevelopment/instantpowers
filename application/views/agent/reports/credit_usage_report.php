...
<p class="box">
	<a href="/master_agent/reports/view_sub_agent_credit_usage" class="btn"><span>Back To "Search By Date" Form</span></a>

</p>
<? if( count( $credits ) ): ?>
<?= form_open( '/master_agent/reports/process_sub_agents_clear_credits' ); ?>
