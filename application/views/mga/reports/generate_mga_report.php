...
<p class="box">
	...
	<a href="<?= safe_url( '/mga/reports', 'submit_mga_agent_report', array( $ins_id ) ); ?>" class="btn-create">
			<span>Submit Report To <?= $agency_name; ?></span>
		</a>
	<a target="_blank" href="/_tasks/print_master_report.cfm?var1=<?= $ins_id; ?>&var2=<?= $this->session->userdata( 'mek' ); ?>&var3=0&var4=<?= $sub_agent; ?>&var5=mgauser" class="btn-list"><span>Print Report</span></a>
