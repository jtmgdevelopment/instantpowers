 ...
 *
 * @access	public
 * @param	string	value of <select>'s name attribute
 * @param	string	value of <option> to be selected
 * @param	string	value of <select>'s id attribute (optional)
 * @param	string	value of <select>'s class attribute (optional)
 * @return	string
 **/
 ...
 *
 * @access	public
 * @param	string	states two-letter abbreviation
 * @return	string
 **/
 ...
 *
 * @access	public
 * @param	string	two-letter abbreviation OR full state name
 * @return	boolean
 **/
