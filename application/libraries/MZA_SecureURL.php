...
class MZA_SecureUrl{
   ...
   function setSecureUrl_encode($class,$function, $param = array()){ // array $param only singel dimension of array, can't <span class="short_text" id="result_box" lang="en"><span class="hps">multiple</span> <span class="hps">dimensions</span></span>.
