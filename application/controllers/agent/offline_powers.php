...
class offline_powers extends Agent_Controller {
...
*/
	...
	{
		parent::__construct();
		$this->view 	= 'agent/powers/offline/';
	...
	public function process_offline_frm()
	{
		...
		else
		{
			...
			$this->set_message( $msg, 'done' , '/agent/cpanel' );
	...
	public function index()
	{
		...
		if( $d[ 'credits']->credit_count == 0 )  $this->set_message( 'You have 0 credits, please purchase more credits', 'error', '/agent/manage_credits' );
